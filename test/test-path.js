...
describe('Path', () => {
  ...
  describe('toString', () => {
    ...
    it('creates an insecure string correctly', () => {
      let path = new Path('/path/to/image.png', 'my-source.imgix.net', null, false);
      assert.equal(path.toString(), "http://my-source.imgix.net/path/to/image.png");
    });

    it('encodes with a token correctly', () => {
      let path = new Path('/users/1.png', 'my-social-network.imgix.net', 'FOO123bar');
    ...
    it('encodes a fully-qualified URL correctly', () => {
      let path = new Path('http://avatars.com/john-smith.png', 'my-social-network.imgix.net', 'FOO123bar');
