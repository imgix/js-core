...
(function (global, factory) {
  ...
  var ImgixClient = (function() {
    function ImgixClient(opts: object | {}) {
      var key, val;
    ...
    ImgixClient.prototype.buildURL = function(path: string, params: object | {}): string {
    ...
    ImgixClient.prototype._sanitizePath = function(path: string): string {
    ...
    ImgixClient.prototype._buildParams = function(params: {}): string {
      ...
      console.log(typeof queryParams.join('&'));
      return queryParams.join('&');
    };

    ImgixClient.prototype._signParams = function(path: string, queryParams: any): string {
    ...
    ImgixClient.prototype.buildSrcSet = function (path: string, params: any): string {
      var params = params || {};
      var width = params.w;
      var height = params.h;
    ...
    ImgixClient.prototype._buildSrcSetPairs = function(path: string, params: any): string {
      var srcset = '';
      var currentWidth;
    ...
    ImgixClient.prototype._buildDPRSrcSet = function(path: string, params: any): string {
        var srcset = '';
